...
color.me.dis <- which(s13$disease_screening_1 == "Plot A")
...
color.me.dis <- which(s15$disease_screening_2 == "Plot A")
...
color.me.dis <- which(s17$disease_screening_3 == "Plot A")
...
color.me.dis <- which(s19$disease_screening_4 == "Plot A")
...
There are `r na_he1` missing observations for this question. Complete responses can be seen below.
...
There are `r na_he2` missing observations for this question. Complete responses can be seen below.
...
color.me.he3 <- which(s25$he_said_she_said_3_3 == "TRUE")
...
There are `r na_he3` missing observations for this question. Complete responses can be seen below.
...
color.me.build <- which(s27$build_a_plot == "County boundaries,Number of adults living in each county,Number of unemployed adults living in each county")
...
color.me.data <- which(s38$data_confidentialil_1 == "")
